...
var PARTICLES = PARTICLES = WIDTH * WIDTH;
var BOUNDS = BOUNDS = 800, BOUNDS_HALF = BOUNDS_HALF = BOUNDS / 2;
...
function init() {
  ...
  simulator = new SimulationRenderer(WIDTH, renderer, PARTICLES, BOUNDS, BOUNDS_HALF);
  simulator.init();
...
function initBirds() {
  ...
  window.birdMesh = new THREE.Mesh( geometry, material );
